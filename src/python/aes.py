...
def print_round_key(w):
    ...
    [print([matrix[i][j] for j in range(4)]) for i in range(4)]
...
def Cipher(text_in, w):
    ...
    # out[r+4c]=s[r,c] for0≤r<4 and 0≤c<Nb. (3.4)
    pass
#    out = None
#
#    byte  state[4,Nb]
...
# w0 = 2b7e1516 w1 = 28aed2a6 w2 = abf71588
# w3 = 09cf4f3c
